...
public class ColorChooser extends JDialog {
	...
	private ColorModel color; // Color model
	...
	public ColorChooser(JFrame owner, Integer red, Integer green, Integer blue) {
		...
		color = new ColorModel(red, green, blue);
		init();
	}
	...
	public void init() {
		...
		panel.add(slider);
		color.red.bind(slider);
		// Green
		slider = new JSlider(JSlider.HORIZONTAL, 0, 255, 127);
		panel.add(slider);
		color.green.bind(slider);
		// Blue
		slider = new JSlider(JSlider.HORIZONTAL, 0, 255, 127);
		panel.add(slider);
		color.blue.bind(slider);
		// Add to window
		pane.add(panel);
		...
		panel.add(textField);
		color.red.bind(textField);
		// Green
		textField = new JTextField(3);
		panel.add(textField);
		color.green.bind(textField);
		// Blue
		textField = new JTextField(3);
		panel.add(textField);
		color.blue.bind(textField);
		// Add to window
		pane.add(panel);
	...
	static public void main(String args[]) {
		...
		System.out.println("Selected color is: " + rgb.getColor().toHex());
		System.exit(1);
	}
